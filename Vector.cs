namespace Vector
{
    public class Vector
    {
        ...
        {
            if (i < 0 || i > Length - 1)
                throw new Matrix.MatrixVectorException("Invalid index specified");
            return element[i];
        }
        ...
        /// </summary>
        public static Vector Multiply(Matrix.Matrix matrix1, Vector vec)
        {
            if (matrix1.Cols != vec.Length)
                throw new Matrix.MatrixVectorException("Operation not possible");
        ...
        /// </summary>
        public static Vector operator *(Matrix.Matrix matrix1, Vector vec)
